...
- [x] 1.3 docker-compose.yml into the repo: tags backendv1.0.3 / frontendv1.0.1; dead API_PREFIX/API_BASE env vars removed
...
- [ ] 1.6 Push backendv1.0.3 + frontendv1.0.1 to ECR — BLOCKED: 403 for IAM user atharva_maskar; needs admin-granted ECR push rights (AmazonEC2ContainerRegistryPowerUser or repo-scoped). Images are built and ready locally.
